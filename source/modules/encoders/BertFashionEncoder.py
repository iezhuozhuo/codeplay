...
class BertSelfAttention(nn.Module):
    def __init__(self, args):
        ...
        if args.hidden_size % args.num_attention_heads != 0 and not hasattr(args, "embedded_size"):
            raise ValueError(
...
class BertFashionLayer(nn.Module):
...
class BertFashionEncoder(nn.Module):
    def __init__(self, args):
        super(BertFashionEncoder, self).__init__()