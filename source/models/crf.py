...
class CRF(nn.Module):
    def __init__(self, tagset_size, tag_dictionary, device, is_bert=True):
    ...
    def calculate_loss(self, features, tag_list, lengths):
        return self._calculate_loss_old(features, lengths, tag_list)
